      ...
      <div className='container mx-auto py-5 px-4 flex items-center justify-between'>
        ...
        <div className='sm:flex items-center gap-6 hidden'>
          ...
          {session.status === "unauthenticated" ? (
            ...
            <Button
              className='bg-[#1a2e41] text-white rounded-full hover:bg-[#334555]'
            ...
            {session.status === "unauthenticated" ? (
              <>
                <Link href="/signup" onClick={closeMenu}>
                  <Button className="bg-[#1a2e41] text-white rounded-full hover:bg-[#334555] w-full">
                    Sign Up
                  </Button>
                </Link>
              ...
              <Button
                onClick={handleSignOut}
                className="bg-[#1a2e41] text-white rounded-full hover:bg-[#334555] w-full"
              >
                Sign Out
              </Button>
            )}
