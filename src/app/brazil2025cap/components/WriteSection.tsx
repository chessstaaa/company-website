...
const WriteSection = async () => {
    ...
    return (
        <div className="container mx-auto py-8 px-4">
            <div className="bg-[#f8f8f8] border p-8 rounded-md text-center">
                <h3 className="text-xl sm:text-2xl font-semibold mb-2">Sign in to write a review</h3>
                <p className="text-sm sm:text-base mb-6">You can still view this product and other reviews. Please sign in to add your own.</p>
